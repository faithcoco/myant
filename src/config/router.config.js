...
export const asyncRouterMap = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'OutManagement',
                component: RouteView,
                redirect: '/StockOutRecordAdd',
                meta: {title: '出库管理', icon: 'user', permission: ['03']},
                children: [
                    {
                        path: 'StockOutRecordList',
                        name: 'StockOutRecordList',
                    ...
                    {
                        path: 'StockOutRecordAdd',
                        name: 'StockOutRecordAdd',
            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        meta: {title: '管理员表单设置', icon: 'user', permission: ['admin']}
                    }
                ]
            },
            {
