  ...
  <a-card>
    ...
    >
      <a-form-model-item label="货位调整单编码" required prop="coding">
        <a-input v-model="form.CargoSpaceAdjustmentOrder" placeholder="请输入货位调整单编码">
      ...
      <a-form-model-item label="目标货位编码" prop="code">
        <a-input v-model="form.TargetLocationCode" placeholder="请输入目标货位编码" />
      </a-form-model-item>
