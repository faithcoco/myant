  ...
  <a-layout>
    <a-card>
      <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        <a-form-model-item label="收货单编码" required prop="ReceiptNotificationCode">
          <a-input v-model="form.ReceiptNotificationCode" placeholder="请输入收货通知单编码" @blur="() => {}">
...
export default {
  data() {
    return {
      ...
      rules: {
        ReceiptNotificationCode: [{ required: true, message: '请输入收货单编码', trigger: 'blur' }],
