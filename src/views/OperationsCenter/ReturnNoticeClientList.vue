...
import { getOrgTree, getServiceList, getReturnNoticeClientList } from '@/api/manage'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      disabled: false,
      loadData: parameter => {
        return getReturnNoticeClientList(Object.assign(parameter, this.queryParam)).then(res => {
          console.log('/getReturnNoticeClientList-->', JSON.stringify(res))
          return res.result
        })
      },
      comments: [
