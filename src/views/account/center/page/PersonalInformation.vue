<template>
  <div>
    ...
    >
      ...
      <a-form-model ref="mailRuleForm" :model="form" :rules="Mrules">
    ...
    >
      <a-form-model ref="CPruleForm" :model="form" :rules="GPrules">
        <a-form-model-item label="新密码:" prop="newPersonPassword">
          <a-input-password v-model="form.newPersonPassword" placeholder="请输入密码"></a-input-password>
        </a-form-model-item>
        <a-form-model-item label="确认密码:" prop="CPersonPassword">
          <a-input-password v-model="form.CPersonPassword" placeholder="请输入密码"></a-input-password>
        </a-form-model-item>
