<template>
  ...
  >
    ...
    <a-form-model-item ref="name" label="产品条码" prop="name">
      <a-input
        v-model="form.name"
        placeholder="请输入产品条码"
        @blur="
    ...
    <a-form-model-item ref="name" label="规格型号" prop="name">
      <a-input
        v-model="form.name"
        placeholder="请输入规格型号"
        @blur="
    ...
    <a-form-model-item ref="name" label="计量单位" prop="name">
      <a-input
        v-model="form.name"
        placeholder="请输入计量单位"
        @blur="
    ...
    <a-form-model-item label="产品分类" prop="region">
      <a-select
        show-search
        placeholder="请选择产品分类"
    ...
    <a-form-model-item ref="name" label="销售单价" prop="name">
      <a-input
        v-model="form.name"
        placeholder="请输入销售单价"
        @blur="
    ...
    <a-form-model-item ref="name" label="采购单价" prop="name">
      <a-input
        v-model="form.name"
        placeholder="请输入采购单价"
        @blur="
    ...
    <a-form-model-item label="产品说明" prop="desc">
      <a-input v-model="form.desc" type="textarea" placeholder="30字以内产品说明" />
    </a-form-model-item>
    <a-form-model-item label="附件" prop="desc">
      <a-upload
        name="file"
        :multiple="true"
